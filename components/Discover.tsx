...
const topicStyle = "xl:border-2 hover:bg-primary xl:border-gray-200 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-black"

  return (
    <div className='xl:border-b-2 xl:border-gray-200 pb-6'>
        <p className='text-gray-500 font-semibold mt-4 m-3 hidden xl:block '>Popular Topics</p>
