                                ...
                                {videoAsset ? (
                                    ...
                                    <label className='cursor-pointer'>
                                        <div className='flex flex-col items-center justify-center h-full'>
                                            ...
                                            <p className='text-gray-400 text-center mt-10 text0sm leading-10'>
                                                MP4 or Webm or ogg <br />
                                                720x1280 or higher <br />
                                                up to 10 minutes <br />
                                                Less than 2GB
                                            </p>
                                            <p className='bg-white text-[#F51997] 
                                            border-[#F51997] border-2 hover:text-white
                                                hover:bg-[#F51997] text-center
                                                mt-10 rounded text0md
                ...
                <div className='flex flex-col gap-3 pb-10 '>
                    ...
                    <div className='flex gap-6 mt-10'>
                        ...
                        <button
                            type='button'
                            onClick={handlePost}
                            className='bg-white text-[#F51997] border-[#F51997] border-2 hover:text-white
                            hover:bg-[#F51997]  text-md font-medium p-2 rounded w-28 lg:w-44 outline-none'
                        >
                            Post
                        </button>
                    </div>
